...
4. The agent should follow [AGENTS.md](AGENTS.md) and `.cursor/rules/`: you answer each interview step; the agent analyzes it, covers options and tradeoffs, then implements.

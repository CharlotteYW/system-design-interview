...
**Status:** Stub  
**Sources:** Hello Interview; Alex Xu Vol 1 Ch 14  
**Slug:** `youtube`
...
Design a video platform (like YouTube): upload, transcode, store, and stream videos with a simple recommendation/view path.

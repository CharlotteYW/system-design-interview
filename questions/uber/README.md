...
**Status:** Stub  
**Sources:** Hello Interview; related: Alex Xu Vol 2 Proximity Service  
**Slug:** `uber`
...
Design a ride-matching service (like Uber): track driver locations, match a rider to a nearby driver, and keep matching consistent.
